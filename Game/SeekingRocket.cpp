...
void SeekingRocket::SetAttributes(const std::string& name, const spic::Point& position, const float angle)
{
	Name(name);
	Tag("rocket");
...
void SeekingRocket::SetSteeringBehaviours()
{
...
void SeekingRocket::SetGroupBehaviours()
{
