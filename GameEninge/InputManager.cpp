...
void InputManager::Listen() {
	spic::Point newMousePosition = spic::Input::MousePosition();
...
void InputManager::TriggerKeyPressed(spic::Input::KeyCode key) {
	for (auto keyListener : keyListeners[key]) {
